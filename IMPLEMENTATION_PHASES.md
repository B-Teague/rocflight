...
all 1,953 do as of 2026-09-19, measured by `tests/check_eval.sh --strict`; Phase 23
below is the ledger of how they got there. Second, per feature, **all four outputs are
byte-identical**:
